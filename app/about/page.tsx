...
const values = [
    {
        icon: Eye,
        title: "Vision",
        description: "To set a new global standard for premium education in Egypt — one that combines the best of international curricula with a deep respect for local culture and values.",
    },
    {
        icon: Target,
        title: "Mission",
        description: "To provide uncompromising quality education that balances academic mastery with personal growth, creativity, and ethical responsibility.",
    },
    {
        icon: Heart,
        title: "Philosophy",
        description: "Education that transcends academics — a transformative experience that nurtures intelligence, builds character, and unleashes creativity.",
    },
    {
        icon: Award,
        title: "Legacy",
        description: "Building on KLS's decades of educational excellence, SIA represents the pinnacle chapter — a commitment to being the very best.",
    },
];
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-muted-foreground leading-relaxed">
                            KLS SIA is more than a school — it's a movement to redefine what premium
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="space-y-4 text-muted-foreground leading-relaxed">
                                <p>
                                    At KLS SIA, we believe that true education is transformative. It goes beyond
                                ...
                                <p>
                                    Every child at KLS SIA is seen, valued, and challenged to become the best
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                            <p>
                                KLS SIA builds upon decades of educational excellence established by KLS.
                                For generations, KLS has been synonymous with quality education in Egypt,
                            ...
                            <p>
                                When you choose KLS SIA, you're not just choosing a school — you're joining
